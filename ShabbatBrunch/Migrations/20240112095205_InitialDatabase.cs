        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Auteur = table.Column<string>(type: "TEXT", maxLength: 60, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Prenom = table.Column<string>(type: "TEXT", maxLength: 60, nullable: false),
                    Telephone = table.Column<string>(type: "TEXT", nullable: false),
                    NbCouvert = table.Column<int>(type: "INTEGER", nullable: false),
                    Date = table.Column<DateOnly>(type: "TEXT", nullable: false),
                    Heure = table.Column<TimeOnly>(type: "TEXT", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Allergenes = table.Column<int>(type: "INTEGER", nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_CarteItems", x => x.Id);
                    table.ForeignKey(
                        name: "FK_CarteItems_Carte_CarteId",
                        column: x => x.CarteId,
